...
# ==========================================
    ...
    with col1:
        issue = st.text_input("ชื่อประเด็นความเสี่ยง:", "แรงงานบังคับ / ค่าธรรมเนียมสรรหา")
        st.write("---")
        st.write("**คำนวณ Severity (ใช้ค่าที่สูงที่สุด ไม่เอาค่าเฉลี่ย)**")
    ...
    if st.button("💾 บันทึกประเด็นนัยสำคัญ (Statement of Salient Issues)"):
        ...
        if sheet:
            ...
            st.success("✅ บันทึกความเสี่ยงเรียบร้อย ข้อมูลเข้าช่อง Salient ถูกต้อง")
