...
# --- 2. เครื่องยนต์เชื่อมต่อ Google Sheet (ทนทานต่อ DNS และ Key format) ---
def connect_to_sheet():
    for attempt in range(3):
        try:
            ...
            # ล้างค่า Private Key ให้ใช้ได้จริง (แก้ปัญหา \n)
            ...
            if not sheet.get_all_values():
                headers = ["Timestamp", "Tool", "Data1", "Data2", "Data3", "Data4", "Data5", "Data6", "Data7", "Data8", "Score"]
...
# --- 6. TOOL CONTENT (คืนเนื้อหาครบ 100% ตามต้นฉบับพี่) ---
...
if choice == "Tool 1: แบบประเมินสถานะองค์กร":
    ...
    with st.form("form_t4"):
        ...
        note = st.text_area("บันทึกสิ่งที่พบเพิ่มเติมจากการสังเกตการณ์:")
    ...
    st.info("ระบบกำลังเตรียมการเชื่อมต่อ API เพื่อวิเคราะห์ข้อมูลไขว้ระหว่าง Tool 1-4")
